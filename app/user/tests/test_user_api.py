...
class PublicUserApiTests(TestCase):
    ...
    def test_create_user_success(self):
        """Test creating a use is successful"""
        payload = {
...
class PrivateUserApiTests(TestCase):
    ...
    def test_recieve_profile_success(self):
        """Test etrieveing profile for logged in user."""
        res = self.client.get(ME_URL)
    ...
    def test_update_user_profile(self):
        """Test updating the user profile for the uathenticated user"""
